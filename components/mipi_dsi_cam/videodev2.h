...
/*
 *  Video for Linux Two header file - ESP-IDF compatible version
 */
...
// ==================== DÉFINITIONS DE TYPES POUR ESP-IDF ====================
// Ces types sont normalement définis dans linux/types.h
// Nous les définissons ici pour la compatibilité avec ESP-IDF
...
// Définitions des macros ioctl pour ESP-IDF
#ifndef _IOC
...
#endif /* __LINUX_VIDEODEV2_H */, b, c, d) | (1U << 31))
